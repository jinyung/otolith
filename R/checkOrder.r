#' Check outline order
#' 
#' @description Checking whether the outline XY coordinates are in order, i.e. whether successive points' indices are in successive order? This is important because 'equaldist' function assumes the coordinates are ordered.
